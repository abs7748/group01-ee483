...
class ImageProcessor: 
    ...
    def white_filter(self):
        ...
        mask = cv2.inRange(self.hsv_image, (80,0,150),(140,50,255))

        mask2 = cv2.inRange(self.hsv_image, (13,0,130),(33,255,255))
    ...
    def segment(self):
        ...
        edges = cv2.Canny(self.cv_crop, 100, 255)
        ...
        # CHANGE VALUES IF NEEDED 
        hough_yellow = cv2.HoughLinesP(edges_yellow, 1, np.pi / 180, 10,minLineLength=10,maxLineGap=50)
